            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Perdagangan</h4>
                        <p class="m-0">Perdagangan grosir suku cadang, produk pertanian, bahan baku makanan dan minuman, peralatan dan aksesoris komputer</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Konstruksi</h4>
                        <p class="m-0">Pengolahan dan penyimpanan barang minyak dan gas, instalasi minyak dan gas, instalasi mekanik, dan instalasi listrik</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Pelayanan</h4>
                        <p class="m-0">Transportasi darat, laut, udara, dan Penyimpanan atau pergudangan, desain dan implementasi</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn; position:center;">
