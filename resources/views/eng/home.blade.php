        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <a href="/profil" class="btn btn-dark py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;">More Information</a>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="mb-0">Our Best Service</h1>
            </div>
            <div class="row g-5">
